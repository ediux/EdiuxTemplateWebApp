...
namespace EdiuxTemplateWebApp.Models.AspNetModels
{
    public static class RepositoryHelper
    {
        ...
        public static IUnitOfWork<TUnitOfWork> GetUnitOfWork<TUnitOfWork>() where TUnitOfWork : DbContext
        {
            return new EFUnitOfWork() as IUnitOfWork<TUnitOfWork>;
        }
        ...
        public static aspnet_ApplicationsRepository Getaspnet_ApplicationsRepository()
        {
            ...
            repository.UnitOfWork = GetUnitOfWork() as IUnitOfWork<AspNetDbEntities2>;
        ...
        {
            var repository = new aspnet_ApplicationsRepository();
            repository.UnitOfWork = unitOfWork as IUnitOfWork<AspNetDbEntities2>;
            return repository;
        }
